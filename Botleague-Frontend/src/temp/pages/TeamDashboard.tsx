    ...
    <div style={styles.root}>
      ...
      <div style={styles.statsRow}>
        {[
          ...
          { icon: "📅", bg: "#6366f122", label: "Techfests Joined", value: "3", link: "View techfests →" },
      ...
      <div style={styles.bottomGrid}>
        ...
        <div style={styles.panel}>
          <div style={styles.panelHeader}>
            <span style={styles.panelTitle}>Upcoming Techfests</span>
          ...
          <span style={styles.seeAll}>See all techfests →</span>
        </div>
      </div>
    </div>
  );
