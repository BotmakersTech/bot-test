...
import sport5 from "../../../assets/home/Img/sports-img/sport5.png";
...
const SPORTS = [
  ...
  { src: sport5, alt: "Robotics stage installation" },
];
    ...
    <section className="py-16 md:py-[70px]">
      <div className="max-w-[1180px] mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3.5">
          {SPORTS.map((sport) => (
            <div key={sport.alt} className="h-[280px] md:h-[420px] rounded-2xl overflow-hidden">
