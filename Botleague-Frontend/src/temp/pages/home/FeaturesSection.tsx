...
const FEATURES = [
  { img: trophyImg, title: "National Ranking", desc: "One National Leaderboard. Every Techfest Counts." },
  { img: certificateImg, title: "Verified Certificates", desc: "QR-Verified Achievements Recognized Across Affiliated Techfests." },
