...
export const NAV_CONFIG: NavItem[] = [
  ...
  { id: "s-events",   label: "All Techfests",           link: "/admin/user",            iconName: "calendar",   roles: [SA] },
  ...
  { id: "a-events",   label: "All Techfests",          link: "/admin/user",             iconName: "calendar",   roles: [ADM] },
  ...
  { id: "og-create",     label: "Create Techfest",       link: "/organizer/events/create",  iconName: "calendar",      roles: [ORGR] },
  ...
  { id: "o-create",     label: "Create Techfest",       link: "/organizer/events/create",  iconName: "calendar",      roles: [ORG] },
  ...
  { id: "c-events",   label: "Techfests",       link: "/browse-events",   iconName: "calendar",    roles: [CMP] },
  ...
  { id: "v-event",   label: "My Techfest",         link: "/volunteer/event",      iconName: "calendar",  roles: [VOL] },
