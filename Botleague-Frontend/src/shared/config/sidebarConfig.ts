...
export const NAV_CONFIG: NavItem[] = [
  ...
  { id: "s-events",   label: "All Techfects",           link: "/admin/user",            iconName: "calendar",   roles: [SA] },
  ...
  { id: "a-events",   label: "All Techfects",          link: "/admin/user",             iconName: "calendar",   roles: [ADM] },
  ...
  { id: "og-closure",    label: "Techfect Closure",      link: "/organizer/closure",        iconName: "audit",         roles: [ORGR] },
  ...
  { id: "o-closure",    label: "Techfect Closure",      link: "/organizer/closure",        iconName: "audit",         roles: [ORG] },
  ...
  { id: "c-events",   label: "Techfects",       link: "/browse-events",   iconName: "calendar",    roles: [CMP] },
  ...
  { id: "v-event",   label: "My Techfect",         link: "/volunteer/event",      iconName: "calendar",  roles: [VOL] },
