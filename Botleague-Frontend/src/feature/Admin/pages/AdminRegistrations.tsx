...
export default function AdminRegistrations() {
  ...
  return (
    <div className="org-page-bg p-8">
      <div className="mb-6">
        <h1 className="font-display text-[clamp(20px,4vw,38px)] font-medium text-[#0162d1] tracking-wide">Registrations</h1>
      ...
      <div className="flex flex-wrap gap-3 mb-5">
        {loadingEvents ? (
          <p className="text-sm text-gray-400">Loading techfests…</p>
        ) : (
          <>
            <select
      ...
      {error ? (
        ...
        <div className="flex items-center justify-center py-20 text-gray-400">Select a techfest and sport to view registrations</div>
      ) : filtered.length === 0 ? (
