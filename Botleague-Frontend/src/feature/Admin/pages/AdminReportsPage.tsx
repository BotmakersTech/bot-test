  ...
  return (
    <div className="org-page-bg p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm mt-1">Platform-wide overview across all techfests</p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
            {[
              { label: "Total Techfests",    value: events.length,  color: "text-orange-600" },
              { label: "Active Techfests",   value: activeCount,    color: "text-green-600" },
          ...
          {events.length === 0 ? (
            <div className="flex items-center justify-center py-16 text-gray-400">No techfests yet</div>
          ) : (
          ...
          <div className="mt-8 rounded-xl bg-white border p-5" style={{ borderColor: "rgba(75,134,232,0.2)" }}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              <div>
                <p className="text-gray-400 text-xs">Completed Techfests</p>
                <p className="text-[#374151] font-semibold mt-0.5">{completedCount}</p>
              </div>
              <div>
                <p className="text-gray-400 text-xs">Upcoming Techfests</p>
              ...
              <div>
                <p className="text-gray-400 text-xs">Avg Teams / Techfest</p>
                <p className="text-[#374151] font-semibold mt-0.5">
                  {events.length > 0 ? (totalTeams / events.length).toFixed(1) : "—"}
                </p>
              </div>
              <div>
                <p className="text-gray-400 text-xs">Avg Sports / Techfest</p>
                <p className="text-[#374151] font-semibold mt-0.5">
