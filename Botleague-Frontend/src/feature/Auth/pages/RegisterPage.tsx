...
const ROLES = [
  ...
  },
  {
    ...
    hoverDesc: "Help run the show — check-ins, logistics, and keeping matches on schedule at live techfests.",
    icon: (
      <svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor">
  ...
  },
  {
    ...
    hoverDesc: "Create and manage your own techfests — registrations, schedules, judging, and live results, all in one place.",
    icon: (
      <svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor">
