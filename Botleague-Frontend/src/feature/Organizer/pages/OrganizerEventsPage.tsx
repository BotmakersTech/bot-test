  ...
  return (
    ...
    <div className="org-page-bg p-8 el-desktop-only" style={{ fontFamily: ORG.fontBody }}>
      <div style={{ marginBottom: "24px", display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <h1 style={{ color: "#0162d1", fontFamily: ORG.fontHeading, fontSize: "clamp(20px,4vw,38px)", fontWeight: 500, margin: 0, letterSpacing: "0.02em" }}>Techfest Management</h1>
      ...
      {/* Table */}
      {loading ? (
        <div style={{ textAlign: "center", padding: "80px 0", color: MUTED }}>Loading techfests…</div>
      ) : filtered.length === 0 ? (
        <div style={{ textAlign: "center", padding: "80px 0", color: MUTED }}>No techfests found</div>
      ) : (
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
            <thead>
              <tr style={{ background: "rgba(75,134,232,0.06)", borderBottom: `1px solid ${BORDER}` }}>
                <th style={{ textAlign: "left", padding: "12px 16px", color: MUTED, fontSize: "0.7rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em" }}>Techfest</th>
