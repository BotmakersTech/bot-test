  ...
  return (
    <div className="p-8" style={{ minHeight: "100vh", background: BG, fontFamily: "'Inter',sans-serif" }}>
      <div style={{ marginBottom: "24px" }}>
        <h1 style={{ color: "#0162d1", fontFamily: "'Orbitron',sans-serif", fontSize: "clamp(20px,4vw,38px)", fontWeight: 500, margin: 0 }}>All Techsports</h1>
        ...
        <div style={{ flex: 1, minWidth: "240px", display: "flex", gap: "8px" }}>
          <div style={{ flex: 1, position: "relative" }}>
            ...
            <input
              ...
              placeholder="Search by sport, techfest, age group…"
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
            <thead>
              <tr style={{ background: "rgba(140,108,255,0.06)", borderBottom: `1px solid ${BORDER}` }}>
                {["Sport", "Techfest", "Age Group", "Weight Class", "Teams", "Status", ""].map((h, i) => (
            ...
            <tbody>
              {filtered.map((sp, i) => (
                <tr key={`${sp.eventId}-${sp.id}`}
                  ...
                  <td style={{ padding: "13px 14px", color: MUTED }}>{ageGroupLabel(sp.ageGroup)}</td>
