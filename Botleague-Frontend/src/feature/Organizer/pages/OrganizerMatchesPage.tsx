  ...
  return (
    <div className="p-8" style={{ minHeight: "100vh", background: BG, fontFamily: "'Inter',sans-serif" }}>
      <div style={{ marginBottom: "24px", display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <h1 style={{ color: "#0162d1", fontFamily: "'Orbitron',sans-serif", fontSize: "clamp(20px,4vw,38px)", fontWeight: 500, margin: 0 }}>Match Management</h1>
      ...
      {error ? (
        ...
        <div style={{ textAlign: "center", padding: "80px 0", color: MUTED }}>Select a techfest and sport to view matches</div>
      ) : loading ? (
