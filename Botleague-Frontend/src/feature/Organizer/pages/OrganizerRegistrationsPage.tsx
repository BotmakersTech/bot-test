  ...
  return (
    <div className="p-8" style={{ minHeight: "100vh", background: BG, fontFamily: "'Inter',sans-serif" }}>
      <div style={{ marginBottom: "24px" }}>
        <h1 style={{ color: "#0162d1", fontFamily: "'Orbitron',sans-serif", fontSize: "clamp(20px,4vw,38px)", fontWeight: 500, margin: 0 }}>Registrations</h1>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", marginBottom: "20px" }}>
        {events.length > 0 && (
          <select value={selectedEventId} onChange={e => handleEventChange(e.target.value)} disabled={loadingEvents}
            ...
            <option value="">— Select Techfest —</option>
      ...
      {error ? (
        ...
        <div style={{ textAlign: "center", padding: "80px 0", color: MUTED }}>Select a techfest and sport to view registrations</div>
      ) : loadingRegs ? (
