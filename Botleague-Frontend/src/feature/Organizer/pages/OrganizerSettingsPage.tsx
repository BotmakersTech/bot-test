...
export default function OrganizerSettingsPage() {
  ...
  return (
    <div className="min-h-full p-8 space-y-6">
      <div>
        <h1 className="font-display text-[clamp(20px,4vw,38px)] font-medium text-[#0162d1]">Techfest Settings</h1>
      ...
      {/* Event selector */}
      <div>
        <label className="text-xs text-[#5d5d5d] mb-1 block font-semibold">Techfest</label>
        ...
        <>
          ...
          <div className="rounded-2xl border border-[#4b86e8]/25 bg-white/90 p-5 space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Techfest Code"  value={event.eventCode} readOnly />
          ...
          <div className="rounded-2xl border border-[#4b86e8]/25 bg-white/90 p-5 space-y-4">
            <h2 className="text-sm font-semibold text-[#111111]">Techfest Information</h2>
            <Field label="Techfest Name *" value={form.eventName ?? ""} onChange={set("eventName")} />
            <div>
