// ======================================================
// UserEventPage.tsx
// Logged-in "Browse Techfests" dashboard view — Route: /browse-events
      ...
      <div className="relative z-10  mx-auto flex flex-col gap-6">
        ...
        {!loading && !error && events.length > 0 && filtered.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center gap-2">
            ...
            <h3 className="evt-heading-mobile evt-font-poppins font-bold text-[14px] text-[#1a1a2e]">No techfests found</h3>
        ...
        {!loading && !error && events.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center gap-2">
            ...
            <h3 className="evt-heading-mobile evt-font-poppins font-bold text-[14px] text-[#1a1a2e]">No live techfests right now</h3>
